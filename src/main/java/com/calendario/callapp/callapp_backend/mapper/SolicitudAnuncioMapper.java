...
public interface SolicitudAnuncioMapper {
    ...
    @Mapping(target = "oficinaId", expression = "java(entity.getOficina() != null ? entity.getOficina().getId() : (entity.getUsuarioSolicitante().getOficina() != null ? entity.getUsuarioSolicitante().getOficina().getId() : null))")
    @Mapping(target = "oficinaNombre", expression = "java(entity.getOficina() != null ? entity.getOficina().getNombre() : (entity.getUsuarioSolicitante().getOficina() != null ? entity.getUsuarioSolicitante().getOficina().getNombre() : \"N/A\"))")
